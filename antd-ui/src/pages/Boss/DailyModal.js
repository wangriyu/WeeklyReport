...
const DailyModal = (props) => {
  const { item, list, modalWidth, loading, modalVisible, columns, startDate, endDate, department, handleModalVisible, handleDateChange } = props;
  const modalOpts = {
  ...
  return (
    <Modal {...modalOpts}>
      ...
      <div id='monthly-table' style={{padding: '5px'}}>
        <Table
