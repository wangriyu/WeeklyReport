export default {
  ...
  'form.submit': '提交',
  'form.save': '保存',
  'form.nickname.placeholder': '用户名',
  'form.name.placeholder': '姓名',
  'form.joinDate.placeholder': '入职日期',
  'form.email.placeholder': '邮箱',
  'form.role.placeholder': '权限级别',
  'form.department.placeholder': '部门，非部门所属不用填',
  'form.password.placeholder': '至少6位密码，区分大小写',
  'form.change-password.placeholder': '密码',
